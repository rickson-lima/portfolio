        ...
        <div className="flex justify-center gap-6">
          {socials.map((social) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-4 rounded-full bg-zinc-900 border border-white/10 text-zinc-400 hover:text-white hover:bg-zinc-800 hover:scale-110 transition-all duration-300"
